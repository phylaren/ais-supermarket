...
router.get('/', verifyToken,  checkRole(['Менеджер', 'Касир']), receiptController.getReceipts);
...
router.get('/daily-cashier-report', verifyToken, checkRole(['Касир']), checkRole(['Менеджер']), receiptController.getCashierDailyReport);
